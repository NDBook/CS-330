...
SceneManager::~SceneManager()
{
	...
	// destroy the created GLTextures
	DestroyGLTextures();
}
...
void SceneManager::LoadSceneTextures() 
{
	...
	bReturn = CreateGLTexture("C:/Users/Nathan/source/repos/CS330Content/Projects/7-1_FinalProjectMilestones/Textures/grass.jpg", "grass");

	bReturn = CreateGLTexture("C:/Users/Nathan/source/repos/CS330Content/Projects/7-1_FinalProjectMilestones/Textures/treebark.jpg", "bark");

	bReturn = CreateGLTexture("C:/Users/Nathan/source/repos/CS330Content/Projects/7-1_FinalProjectMilestones/Textures/iron.jpg", "iron");

	bReturn = CreateGLTexture("C:/Users/Nathan/source/repos/CS330Content/Projects/7-1_FinalProjectMilestones/Textures/woodfinish.jpg", "woodfinish");

	bReturn = CreateGLTexture("C:/Users/Nathan/source/repos/CS330Content/Projects/7-1_FinalProjectMilestones/Textures/PalisadesZoysia.jpg", "zoysia");
...
void SceneManager::DefineObjectMaterials()
{
	...
	OBJECT_MATERIAL ironMaterial;
	ironMaterial.ambientColor = glm::vec3(0.24f, 0.24f, 0.24f);
	ironMaterial.ambientStrength = 0.4f;
	ironMaterial.diffuseColor = glm::vec3(0.3f, 0.3f, 0.2f);
	ironMaterial.specularColor = glm::vec3(0.6f, 0.5f, 0.4f);
	ironMaterial.shininess = 30.0;
	ironMaterial.tag = "iron";

	m_objectMaterials.push_back(ironMaterial);
...
void SceneManager::SetupSceneLights()
{
	...
	// lighting source #1
	m_pShaderManager->setVec3Value("lightSources[0].positon", 0.0f, 0.0f, 0.0f);
	...
	// lighting source #2
	m_pShaderManager->setVec3Value("lightSources[1].positon", -5.0f, 5.0f, 0.0f);
	...
	// lighting source #3
	m_pShaderManager->setVec3Value("lightSources[2].positon", 5.0f, 5.0f, 0.0f);
	...
	m_pShaderManager->setFloatValue("lightSources[2].focalStrength", 0.5f);
	m_pShaderManager->setFloatValue("lightSources[2].specularIntensity", 0.05f);

	// lighting source #4
	m_pShaderManager->setVec3Value("lightSources[3].positon", 0.0f, 5.0f, 5.0f);
	...
	m_pShaderManager->setFloatValue("lightSources[3].focalStrength", 0.5f);
...
void SceneManager::PrepareScene()
{
	...
	// define the textures for objects in the scene
	LoadSceneTextures();
...
void SceneManager::RenderScene()
{
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.0f, 0.15f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-1.0f, 3.5f, 0.0f);
	...
	//SetShaderColor(1, 1, 1, 1);
	SetShaderTexture("iron");
	SetShaderMaterial("iron");
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.65f, 0.15f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-1.08f, 3.75f, 0.0f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.05f, 3.0f, 0.15f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(1.75f, 0.5f, 0.0f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.5f, 2.0f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(1.55f, 1.0f, 1.5f);

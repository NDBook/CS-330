...
GLFWwindow* ViewManager::CreateDisplayWindow(const char* windowTitle)
{
	...
	// this callback is used to capture all mouse wheel events
...
{
	// records first mouse move and subsequent moves to correctly calculate position
	if (gFirstMouse) {
		gLastX = xMousePos;
		gLastY = yMousePos;
		gFirstMouse = false;
	...
	// calculate the x and y offset values for moving the 3D camera
	float xOffset = xMousePos - gLastX;
	float yOffset = gLastY - yMousePos;

	// set the current position to last position variables
	gLastX = xMousePos;
	gLastY = yMousePos;

	// move camera according to calculated offsets
 ...
 *
 *  This method is used to increase or decrease the speed in
 *  which the camera moves around the scene
 ***********************************************************/
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// process camera ascend or descend
	...
	// sets camera to 2D perspective view
	...
	// sets camera to 3D orthographic view
